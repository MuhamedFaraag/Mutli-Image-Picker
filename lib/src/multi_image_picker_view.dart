  ...
  Widget _build(BuildContext context) {
    ...
    return MouseRegion(
      ...
      child: ReorderableBuilder(
        ...
        onReorder: (List<Object?> Function(List<ImageFile>) reOrderCallback) {
          List<ImageFile> imageList = widget.controller.images.toList();
          final newList = reOrderCallback(imageList);
